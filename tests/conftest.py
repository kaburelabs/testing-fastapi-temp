...
# WARNING: Ensure imports from `testing_fastapi_temp` comes after this line
from testing_fastapi_temp import app, settings, db  # noqa
from testing_fastapi_temp.cli import create_user, cli  # noqa
